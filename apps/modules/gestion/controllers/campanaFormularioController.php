...
class campanaFormularioController extends AppController {
    ...
    public function __construct(){
        ...
        $this->objDatos = new campanaFormularioModels();
    }

    public function index($p){        
        $this->view('campana_formulario/form_index.php', $p);
    }
    ...
    public function set_insert_delete_relacion_camp_form($p){
        ...
        $rs = $this->objDatos->set_insert_delete_relacion_camp_form($p);
        $rs = $rs[0];
        //var_export($rs);
        if ($rs['status'] == 'OK' ){
