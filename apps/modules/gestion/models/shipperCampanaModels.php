...
class shipperCampanaModels extends Adodb {
    ...
    public function set_insert_delete_relacion_shipper_campana($p){
        parent::ReiniciarSQL();
        parent::ConnectionOpen($this->dsn, 'set_insert_delete_relacion_shipper_campana');
        parent::SetParameterSP($p['vp_op'], 'varchar');
        parent::SetParameterSP($p['cod_shipper'], 'int');
        parent::SetParameterSP($p['cod_camp'], 'int');
        // echo '=>' . parent::getSql().'<br>'; exit();
        $array = parent::ExecuteSPArray();
        return $array;
    ...
    public function get_list_campana_shipper_no_incluido($p){
        parent::ReiniciarSQL();
        parent::ConnectionOpen($this->dsn, 'get_list_campana_shipper_no_incluido');
        parent::SetParameterSP($p['shi_codigo'], 'int');
        // echo '=>' . parent::getSql().'<br>'; exit();
        $array = parent::ExecuteSPArray();
        return $array;
