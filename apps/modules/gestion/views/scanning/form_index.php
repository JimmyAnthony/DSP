	                                                ...
	                                                items:[
	                                                    {
	                                                        ...
	                                                        id:scanning.id+'-txt-descripcion',
	                                                        labelWidth:60,
	                                                        //readOnly:true,
	                                                        labelAlign:'right',
	                                                        width:'100%',
	                                                		...
	                                                		items:[
	                                                			{
														            ...
														            labelWidth:60,
														            name: 'uploadedfile',
														            id:scanning.id+'-imagen_scanning',
														            buttonText: '',
														            width: '100%',
	                                                        		anchor:'100%',
														            buttonConfig: {
					                                ...
					                                },
					                                {
					                                    ...
					                                    renderer: function(value, metaData, record, rowIndex, colIndex, store, view){
					                                        ...
					                                        return global.permisos({
					                                            ...
					                                            icons:[
					                                                {id_serv: 9, img: 'detail.png', qtip: 'Click para ver detalle.', js: 'scanning.getFormDetalleGestion()'}
					                                            ]
					                                        });
					                                    }
					                                }*/
									...
									items:[
										{
					                        ...
					                        listeners:{
												...
												beforeselect:function(obj, record, index, eOpts ){
													//console.log(record);
													scanning.opcion='U';
													scanning.cod_cam=record.get('cod_cam');
													scanning.getImagen(record.get('imagen'));
													Ext.getCmp(scanning.id+'-txt-nombre').setValue(record.get('nombre'));
													Ext.getCmp(scanning.id+'-txt-descripcion').setValue(record.get('descripcion'));
													Ext.getCmp(scanning.id+'-date-re').setValue(record.get('fec_crea'));
													Ext.getCmp(scanning.id+'-cmb-estado').setValue(record.get('estado'));
													scanning.getReloadGridscanning(record.get('cod_cam'));
												}
					                        }
					                    }
									]
